  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      if (_controller.eventList.isEmpty) {
        ...
        for (var eventMap in _staticEvents) {
                    ...
                    children: [
                      TableCalendar(
                        ...
                        onPageChanged: (focusedDay) {
                          log("focusDay  $focusedDay");
                          _controller.setFocusedDay(focusedDay);
                          String focusDayMonth = DateFormat('MM').format(
                              focusedDay); // 'MM' ensures the month has leading zero if needed

                          _controller.fetchEvents(
                              focusDayMonth, focusedDay.year.toString());
                          /*_controller.fetchEventsForMonth(
                                focusedDay.year, focusedDay.month);*/
                        },
                      ),
                      verticalSpace(10),
                      _controller.selectedEvents.isNotEmpty
                          ? Text(
                              "Events",
                              style: pMedium24,
                            )
                      ...
                      ListView.builder(
                        ...
                        itemCount: _controller.selectedEvents.isEmpty &&
                                _staticEvents.isNotEmpty
                            ? _staticEvents.length
                            : _controller.selectedEvents.length,
                        itemBuilder: (context, index) {
                          final isStaticData =
                              _controller.selectedEvents.isEmpty &&
                                  _staticEvents.isNotEmpty;
                            ...
                            child: Container(
                              ...
                              child: ListTile(
                                ...
                                subtitle: Text(
                                  ...
                                  style:
                                      pRegular12.copyWith(color: AppColor.grey),
                                ),
                              ),
                            ),
                          );
